...
var budgetController = (function() {
	...
	var Expense = function(id, description, value) {
		...
		this.value = value;
		this.percentage = -1; // for when its not defined
	};
	...
	var data = {
		...
		budget: 0,
		percentage: -1 // -1 usually means non existent (at the beginning)
...
var UIController = (function() {
	...
	var DOMstrings = {
		...
		var formatNumber = function(num, type) {
			...
			*/
			...
			num = Math.abs(num); // remove the plus or minus infront of number
			num = num.toFixed(2); // adds two decimal numbers at the end (toFixed is a number method from the number object)
	...
	return {
		...
		//changing css class for exp or inc
...
var controller = (function(budgetCtrl, UICtrl) {
	...
	var ctrlAddItem = function() {
		...
		updateBudget(); // called everytime we add an item
